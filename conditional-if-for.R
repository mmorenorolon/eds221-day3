...
species <- c("dog", "elephant", "goat", "dog", "dog", "elephant")
  ...
  #their respective human ages
age_human <- c(3, 8, 4, 6, 12, 18)

  # convert ages to änimal years:
...
animal_ages[i] <- animal_age #populate empty vectors
}
...
# Session B
  #for loops to iterate across columns of a data frame
...
# applying the function mean across the columns by group
penguins %>% 
  group_by(species) %>% 
